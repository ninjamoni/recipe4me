...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Mrz 2018 um 13:41
...
--
-- Tabellenstruktur für Tabelle `amount_ingredients`
--
...
--
-- Daten für Tabelle `amount_ingredients`
--
...
--
-- Indizes für die Tabelle `amount_ingredients`
--
...
--
-- AUTO_INCREMENT für Tabelle `amount_ingredients`
--
ALTER TABLE `amount_ingredients`
...
--
-- AUTO_INCREMENT für Tabelle `recipe_tags`
--
ALTER TABLE `recipe_tags`
  MODIFY `idRecTag` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- Constraints der Tabelle `amount_ingredients`
--
ALTER TABLE `amount_ingredients`
